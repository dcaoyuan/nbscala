...
trait CompilerControl { self: Global =>
  ...
  object CancelActionReq extends Exception with ControlThrowable
  object FreshRunReq extends Exception with ControlThrowable
  object ShutdownReq extends Exception with ControlThrowable
